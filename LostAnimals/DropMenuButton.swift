...
//            tableFrameHeight = self.frame.height * 3
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.setTitle(items[(indexPath as NSIndexPath).row], for: UIControl.State())
        self.setTitle(items[(indexPath as NSIndexPath).row], for: UIControl.State.highlighted)
        self.setTitle(items[(indexPath as NSIndexPath).row], for: UIControl.State.selected)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.separatorInset = UIEdgeInsets(top: 0, left: self.frame.width, bottom: 0, right: self.frame.width)
